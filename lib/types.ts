...
export interface ResiliencePatternSummary {
  name: string;
  description: string;
  config: string;
}

export interface ResilienceScenarioSummary {
...
export interface ResilienceOverview {
  title: string;
  focus: string;
  patterns: ResiliencePatternSummary[];
  currentState: CircuitBreakerStatus;
  scenarios: ResilienceScenarioSummary[];
}
